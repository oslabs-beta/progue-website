  ...
  return (
    <footer class="footer p-10 text-slate-700">
      ...
      <div>
        ...
        <a class="link link-hover" href="/team">
          Meet the Team
        </a>
        <a
          class="link link-hover"
          href="https://github.com/oslabs-beta/progue-for-kafka"
          target="_blank"
        >
      ...
      <div>
        ...
        <div class="grid grid-flow-col gap-4">
          ...
          <a
            class="link link-hover"
            href="https://www.linkedin.com/company/open-source-projects-global/mycompany/verification/"
            target="_blank"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
